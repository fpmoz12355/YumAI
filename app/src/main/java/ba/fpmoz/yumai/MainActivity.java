...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRecipes.setOnClickListener ( new View.OnClickListener () {
            @Override
            public void onClick(View view) {
                redirectActivity ( MainActivity.this, MyRecipesActivity.class );
        ...
        faq.setOnClickListener ( new View.OnClickListener () {
            @Override
            public void onClick(View view) {
                redirectActivity ( MainActivity.this, FAQActivity.class );
    ...
    private void showBottomDialog() {
        ...
        airecipeLayout.setOnClickListener ( new View.OnClickListener () {
            ...
            public void onClick(View v) {
                ...
                startActivity ( new Intent ( MainActivity.this, AddAIRecipeActivity.class ) );
