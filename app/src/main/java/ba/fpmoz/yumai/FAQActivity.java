    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                redirectActivity(FAQActivity.this, ProfileActivity.class);
            }
        });
        ...
        myRecipes.setOnClickListener ( new View.OnClickListener () {
            @Override
            public void onClick(View view) {
                redirectActivity ( FAQActivity.this, MyRecipesActivity.class );
        ...
        settings.setOnClickListener ( new View.OnClickListener () {
            @Override
            public void onClick(View view) {
                redirectActivity ( FAQActivity.this, SettingsActivity.class );
        ...
        about.setOnClickListener ( new View.OnClickListener () {
            @Override
            public void onClick(View view) {
                redirectActivity ( FAQActivity.this, AboutUsActivity.class );
        ...
        faq.setOnClickListener ( new View.OnClickListener () {
            @Override
            public void onClick(View view) {
                redirectActivity ( FAQActivity.this, FAQActivity.class );
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId())
                {
                    ...
                    case R.id.categories:
                        startActivity(new Intent(FAQActivity.this, CategoriesActivity.class));
                        overridePendingTransition(0,0);
                        return true;

                    case R.id.favourites:
                        startActivity(new Intent(FAQActivity.this, FavoritesActivity.class));
                        overridePendingTransition(0,0);
                        return true;
    ...
    private void showBottomDialog() {
        ...
        recipeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(FAQActivity.this, AddRecipeActivity.class));
        ...
        airecipeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog.dismiss();
                Toast.makeText(FAQActivity.this,"Add new AIrecipe is clicked",Toast.LENGTH_SHORT).show();
